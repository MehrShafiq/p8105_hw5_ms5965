...
The sample average of μ^ across tests for which the null is rejected approximately equal to the true value of μ for mu values of 3 or greater. For smaller values there's a difference. 
